    ...
    <section className='max-padd-container pt-[99px]'>
        <div className='max-padd-container bg-hero bg-center bg-cover bg-no-repeat h-[655px] w-full rounded-xl items-center'>
            <div className='relative top-32 xs:top-52'>
                ...
                <p className='my-10 max-w-[32rem] bg-cyan-200/70 text-slate-900 rounded-xl p-2  pl-4'> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Non rerum dolorum cumque magni rem illo quia, autem porro excepturi, quidem commodi ad perferendis culpa.
                </p>
