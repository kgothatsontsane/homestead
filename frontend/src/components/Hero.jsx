    ...
    <section className='max-padd-container pt-[99px]'>
        <div className='max-padd-container bg-hero bg-center bg-cover bg-no-repeat h-[655px] w-full rounded-xl items-center'>
            <div className='relative top-32 xs:top-52'>
                ...
                <p className='my-10 max-w-[32rem] bg-cyan-300/60 text-slate-900 rounded-xl p-2  pl-4'>Explore a wide range of properties tailored to your needs.<br></br>Find your perfect home with ease and confidence.</p>
                ...
                <div className='inline-flex items-center justify-center gap-4 p-2 bg-white rounded-xl'>
                    ...
                    <Link to="/listings" className='btn-secondary rounded-xl flexCenter !py-5'>View Properties</Link>
                </div>
            </div>
        </div>
    </section>
